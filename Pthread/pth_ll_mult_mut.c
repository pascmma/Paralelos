...
TAREA DEL ALBARO CON B

* Implementar un ejemplo donde se muestre las ventajas/deventajas de usar las diferentes implementaciones de barreras en PThreads.
* Mostrar un ejemplo donde se muestre el uso de la barrera implementada en pthreads.
...
* THREAD-SAFETY. Análizar porque strtok no es thread-safe y mostrar un ejemplo de su mal funcionamiento. Explicar porque strtok_r si funciona en un ambiente multitithread.
